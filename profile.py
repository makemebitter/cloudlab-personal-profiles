"""Spawn a cluster and setup the networking, personal scripts to setup various things"""
...
pc.defineParameter("osNode", "OS for the nodes",
                   portal.ParameterType.STRING, "ubuntu18", legalValues=sorted(list(DISK_IMAGES.keys())), 
